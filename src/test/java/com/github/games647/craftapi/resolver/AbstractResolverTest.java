...
import com.github.games647.craftapi.model.skin.TextureModel;
...
public class AbstractResolverTest {
    ...
    public void encodeSkinSteve() throws Exception {
        ...
        SkinProperty property = resolver.encodeSkin(skin,
                hexStringToByteArray("2537D54AB77E8250C73B68253E6B0A75E4CE5CF807C3A9819EF15B640EF94C1ABBB10A083285A3C" +
    ...
    public void encodeSkinSlim() throws Exception {
        ...
        SkinProperty property = resolver.encodeSkin(skin,
                hexStringToByteArray("71345E00F68523B8A2915E4BD70F074140E539F896AE77B4519DC2867F87008233283ECA1FCDE68" +
